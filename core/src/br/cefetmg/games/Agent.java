...
import br.cefetmg.games.pathfinding.HeuristicaDistanciaEuclidiana;
import br.cefetmg.games.pathfinding.HeuristicaLuis;
...
public class Agent {
    ...
    public void setGoal(int x, int y) {
        ...
        HeuristicaNula h = new HeuristicaNula();
        HeuristicaDistanciaEuclidiana he = new HeuristicaDistanciaEuclidiana();
        HeuristicaLuis hl = new HeuristicaLuis();
        // AQUI ESTAMOS CHAMANDO O ALGORITMO A* (instância pathFinder) 
//        pathFinder.searchConnectionPath(startNode, targetNode, h, path);
        pathFinder.searchConnectionPath(startNode, targetNode, hl, path); 
